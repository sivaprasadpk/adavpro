...
public class BookingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		int res=bookDetailsDao.save(details);
		System.out.println("res"+res);
		
		//get a room available in database
		int availablerooms=bookDetailsDao.avaliableRooms(type);
		
		//get a user email from database
		String email = new HostelDao().getEmail(username);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("BookingConfirmServlet");
